...
TEST_CASE("OkadaDisplacement: horizontalDisplacement matches okada85.m",
          "[OkadaDispl]") {
  auto l_check = [](double i_strike, double i_dip, double i_rake,
                    double i_slip, double i_lKm, double i_wKm,
                    double i_depthTopKm, double i_eastKm, double i_northKm,
                    double i_expectUe, double i_expectUn,
                    double i_expectUz) {
    OkadaDisplacement l_model(i_strike, i_dip, i_rake, i_slip, i_lKm * 1000.0,
                              i_wKm * 1000.0, i_depthTopKm * 1000.0);
    double l_ue, l_un;
    l_model.horizontalDisplacement(i_eastKm * 1000.0, i_northKm * 1000.0,
                                   l_ue, l_un);
    double l_uz =
  ...
  l_check(90.0, 30.0, 90.0, 5.0, 100.0, 10.0, 10.0, 3.0, 4.0,
         3.0000962453e-03, 3.0285117166e-01, 1.1670611653e+00);
  ...
  l_check(150.0, 60.0, -30.0, 4.5, 40.0, 20.0, 6.0, 0.0, 0.0,
         4.9881686989e-01, -5.5291941085e-01, -8.8943232971e-01);
...
TEST_CASE("effectiveVerticalDisplacement: sign and magnitude of the "
  ...
  double l_corrected =
      effectiveVerticalDisplacement(0.0, 10.0, 0.0, -1.0, 0.0);
