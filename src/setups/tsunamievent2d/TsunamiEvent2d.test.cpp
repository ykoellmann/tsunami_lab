...
static const float g_zBath[6] = {-200.f, -150.f, -100.f, -180.f, 10.f, -120.f};
...
TEST_CASE("TsunamiEvent2d: nearest-neighbour bathymetry lookup",
          "[TsunamiEvent2d]") {
...
TEST_CASE("TsunamiEvent2d: displacement zero outside grid",
          "[TsunamiEvent2d]") {
  writeTestNc(k_bathPath, g_xBath, 3, g_yBath, 2, g_zBath);
  writeTestNc(k_displPath, g_xDispl, 2, g_yDispl, 2, g_zDispl);
...
TEST_CASE("TsunamiEvent2d: height and bathymetry from Eq. 5.2.1",
          "[TsunamiEvent2d]") {
  writeTestNc(k_bathPath, g_xBath, 3, g_yBath, 2, g_zBath);
  writeTestNc(k_displPath, g_xDispl, 2, g_yDispl, 2, g_zDispl);
...
TEST_CASE("TsunamiEvent2d: domain extent from bathymetry grid",
          "[TsunamiEvent2d]") {
  writeTestNc(k_bathPath, g_xBath, 3, g_yBath, 2, g_zBath);
  writeTestNc(k_displPath, g_xDispl, 2, g_yDispl, 2, g_zDispl);
