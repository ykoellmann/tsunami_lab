...
BATH="${BENCH_BATH:-resources/tsunami_simulations/output/tohoku_gebco20_ucsb3_250m_bath.nc}"
DISPL="${BENCH_DISPL:-resources/tsunami_simulations/output/tohoku_gebco20_ucsb3_250m_displ.nc}"
