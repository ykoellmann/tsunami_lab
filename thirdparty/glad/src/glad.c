/*
    ...
    OpenGL loader generated by glad 0.1.36 on Thu Jun 18 14:45:44 2026.
...
PFNGLRELEASECLIENTPOINTERRANGEMESAPROC glad_glReleaseClientPointerRangeMESA =
    NULL;
...
static void load_GL_MESA_map_buffer_client_pointer(GLADloadproc load) {
  if (!GLAD_GL_MESA_map_buffer_client_pointer)
    return;
  glad_glAddClientPointerRangeMESA =
      (PFNGLADDCLIENTPOINTERRANGEMESAPROC)load("glAddClientPointerRangeMESA");
  glad_glReleaseClientPointerRangeMESA =
      (PFNGLRELEASECLIENTPOINTERRANGEMESAPROC)load(
...
static int find_extensionsGL(void) {
  ...
  GLAD_GL_MESA_map_buffer_client_pointer =
      has_ext("GL_MESA_map_buffer_client_pointer");
