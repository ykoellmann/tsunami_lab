...
.. figure:: ../../../individual_phase/presentation/render.png
   :alt: 3D bathymetry preview
   :width: 70%

   3D bathymetry preview of a selected region with sea-level plane and vertical
   exaggeration applied.

.. note::

   Screenshots of the globe view and region-selection UI will be added once the
   interactive session recording is finalised.
...
- **Mika Brückner:** Project plan and pitch presentation.